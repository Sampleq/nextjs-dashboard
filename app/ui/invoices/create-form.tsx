'use client';
// Since useActionState() is a hook, we need to turn our form into a Client Component using "use client" directive
    ...
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          {/* id="customer-error": This id attribute uniquely identifies the HTML element that holds the error message for the select input. This is necessary for aria-describedby to establish the relationship. aria-live="polite": The screen reader should politely notify the user when the error inside the div is updated. */}
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  // defaultChecked // for Client-Side validation purpose
